...
<!-- State the problem as BEHAVIOUR, not as a number.
     ...
     good: "Jax's high kick whiffs at ranges where it visibly connects"
...
- [ ] I know whether this record is **shared** — Kitana/Mileena/Jade read one
      table, five ninjas read another, and `tables` in `data/boxes.json` says
      who. Editing one edits all of them
